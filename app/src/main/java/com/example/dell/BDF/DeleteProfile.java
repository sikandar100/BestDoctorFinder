...
public class DeleteProfile extends Fragment {
    ...
    private ArrayList<Profile> mProductArrayList = new ArrayList<Profile>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Delete Profile");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        lvProfile = (ListView)view.findViewById(R.id.ListofProfiles);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Toast.makeText(getContext(), "You Have successfully Fetched All Profiles" , Toast.LENGTH_SHORT).show();
                        if (jObj != null) {
                            for (int i=0;i<(jObj.length()-1);i++){
                                mProductArrayList.add( new Profile(jObj.getJSONObject("user"+i).getString("id"),jObj.getJSONObject("user"+i).getString("name")));
                            }
                        }
                        adapter1 = new MyAdapter(getContext(), mProductArrayList);
                        lvProfile.setAdapter(adapter1);
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        private ArrayList<Profile> mOriginalValues; // Original Values
        private ArrayList<Profile> mDisplayedValues;    // Values to be displayed
        LayoutInflater inflater;

        public MyAdapter(Context context, ArrayList<Profile> mProductArrayList) {
                ...
                public void onClick(View v) {
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            //Toast.makeText(getContext(), mDisplayedValues.get(position).name, Toast.LENGTH_SHORT).show();
                            DelProfile(mDisplayedValues.get(position).name);
        ...
        public Filter getFilter() {
            Filter filter = new Filter() {
                ...
                protected void publishResults(CharSequence constraint,FilterResults results) {
                    ...
                    mDisplayedValues = (ArrayList<Profile>) results.values; // has the filtered values
                ...
                protected FilterResults performFiltering(CharSequence constraint) {
                    ...
                    ArrayList<Profile> FilteredArrList = new ArrayList<Profile>();

                    if (mOriginalValues == null) {
                        mOriginalValues = new ArrayList<Profile>(mDisplayedValues); // saves the original data in mOriginalValues
                    }
                    ...
                    if (constraint == null || constraint.length() == 0) {
                        ...
                        for (int i = 0; i < mOriginalValues.size(); i++) {
                            String data = mOriginalValues.get(i).id;
                            if (data.toLowerCase().startsWith(constraint.toString())) {
                                FilteredArrList.add(new Profile(mOriginalValues.get(i).name,mOriginalValues.get(i).id));
                            }
                        }
    ...
    private void DelProfile(final String id) {
        // Tag used to cancel the request
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                URL_FOR_Deleting_Profile, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        //String user = jObj.getJSONObject("user").getString("name");
                        Toast.makeText(getContext(), "You Have successfully Deleted the Profile ", Toast.LENGTH_SHORT).show();
                        progressDialog.setMessage("Working! Plz Wait ...");
                        showDialog();
