 ...
 */
public class DeleteHospital extends Fragment {


    private static final String TAG = "DeleteHospital";
    private static final String Ip = Constants.FixIp;
    private static final String URL_FOR_Deleting_Hospital = Ip+"/BestDoctorFinder/DeleteHospital.php";
    private static final String URL_FOR_All_hospital_fetch = Ip+"/BestDoctorFinder/AllHospitalsFetch.php";
    ProgressDialog progressDialog;

    private EditText etSearch;
    private ListView lvPersons;
    private ArrayList<Person> mProductArrayList = new ArrayList<Person>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Delete Hospital");
        progressDialog = new ProgressDialog(getContext());
        progressDialog.setCancelable(false);
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_delete_hospital, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        lvPersons = (ListView)view.findViewById(R.id.ListofHospitals);
    ...
    private void FetchHospitals() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                URL_FOR_All_hospital_fetch, new Response.Listener<String>() {
                    ...
                    if (!error) {
                        ...
                        if (jObj != null) {
                            for (int i=0;i<(jObj.length()-1);i++){
                                mProductArrayList.add( new Person(jObj.getJSONObject("user"+i).getString("id"),jObj.getJSONObject("user"+i).getString("name")));
                            }
                        }
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.tvId.setText(mDisplayedValues.get(position).id);
                ...
                public void onClick(View v) {
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            DelHospital(mDisplayedValues.get(position).name);
    ...
    private void DelHospital(final String id) {
        // Tag used to cancel the request
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                URL_FOR_Deleting_Hospital, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        //String user = jObj.getJSONObject("user").getString("name");
                        Toast.makeText(getContext(), "You Have successfully Deleted the Hospital ", Toast.LENGTH_SHORT).show();
                        progressDialog.setMessage("Working! Plz Wait ...");
                        showDialog();
